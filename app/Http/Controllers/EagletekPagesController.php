...
class EagletekPagesController extends Controller
{
    private const TIENDA_ID=1;
    private const TIENDA_NAME='eagletekmexico';
    private const TIENDA_DIR='eagletek';
    ...
    public function category($category_id){
        ...
        $products=Product::where('category_id',$category_id)->where('status','0')->orderBy('order_by', 'asc')->paginate(16);
    ...
    public function categorySlug($slug){
        ...
        $products=Product::where('category_id',$category->id)->where('status','0')->orderBy('order_by', 'asc')->paginate(16);
        return view(self::TIENDA_DIR.'.category',[
            'category'=>$category,
            'products'=>$products,
            'shop'=>$shop,
    ...
    public function shoppingCart(){
        $shop=Shop::find(self::TIENDA_ID);
        return view(self::TIENDA_DIR.'.shopping_cart',['shop'=>$shop]);
    }
