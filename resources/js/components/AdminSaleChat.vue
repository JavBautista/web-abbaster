                  ...
                  <ul class="list-unstyled chat scrollbar-light-blue">
                    ...
                    <li v-for="message in arrayMessages" :key="message.id" class="d-flex justify-content-between mb-4">
                      ...
                      <template v-if="message.reply">
                        <img src="/assets/soporte-tecnico.png" width="50px" height="50px" alt="avatar" class="rounded-circle mr-2 ml-lg-3 ml-0 z-depth-1">
                      ...
                      <template v-else>
                        ...
                        <img src="/assets/persona.png" width="50px" height="50px" alt="avatar" class="rounded-circle mr-0 ml-3 z-depth-1">
                      </template>
