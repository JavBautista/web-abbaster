    ...
    export default {
      ...
      computed:{
    	...
    	methods:{
          ...
          url = '/get/visitas-productos/?fecha_ini='+me.fecha_ini+'&fecha_fin='+me.fecha_fin+'&page='+page+'&buscar='+buscar+'&criterio='+criterio;
        ...
        loadChart(){
          ...
          me.arrayProducts.map(function(x){
            me.arrayDataKeys.push(x.key);
            me.arrayDataVisitas.push(x.visitas);
          });
          me.varChartProducts = document.getElementById('chart-products').getContext('2d');
          me.chartProducts = new Chart(me.varChartProducts, {
              type: 'bar',
              data: {
