...
<div class="container">
	...
	<div class="row justify-content-center">
        <div class="col-md-10">
			...
			@include('parts.form_discount_code',['tienda'=>'solartekmexico'])
			...
			<table class="table">
						...
						<tr>
							...
							<td>
								<div class="form-group">
									<form action="/solartekmexico/updateQtyCart" method="post">
										{{ csrf_field() }}
							...
							<td>
								<form action="/solartekmexico/deleteToCart" method="post">
									{{ csrf_field() }}	
									<input type="hidden" name="rowId" value="{{ $row->rowId }}">									
			   	...
			   	<tfoot>
			   		...
			   		<tr>
			   			<td colspan="4">&nbsp;</td>
			   			<td colspan="2">			   				
							<a href="/solartekmexico/shopping-cart/confirm-payment" class="btn btn-block btn-success">Continuar</a>
			   			</td>			   			
			   		</tr>
			   	</tfoot>
			</table>        				
			<a href="/solartekmexico/shopping-cart/clear" class="btn btn-outline-secondary float-left mb-4">Limpiar Carro de compras</a>
        </div>
    </div>
</div>
@endsection