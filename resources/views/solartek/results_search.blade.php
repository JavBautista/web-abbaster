			              ...
			              <div class="card mb-4 shadow-sm">	              
			                ...
			                <div class="card-body">
			                	<p class="card-title">{{ $product->name }}</p>
			                  	...
			                  	<a href="{{ route('solartek.store.category.product',['product_id'=>$product->id, 'category_id'=>$product->category->id])}}" class="btn btn-lg btn-block btn-outline-dark">Ver mas...</a>
			                </div>
			              </div>
			            </div>
			            @endif
