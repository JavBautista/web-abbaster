                ...
                <div class="col-md-3">
                  <div class="card mb-4 text-center shadow-sm h-100">
                    ...
                    <div class="card-footer bg-transparent border-light">
                        @php
                         $url_route= $category->slug?route('solartek.store.category.slug',$category->slug):route('solartek.store.category',$category->id);
                        @endphp
                        <a href="{{ $url_route }}" class="btn btn-sm btn-outline-block btn-dark stretched-link">Vamos <i class="fa fa-arrow-alt-circle-right"></i></a>
                    </div>
                  </div>
                </div>
            @empty
