...
<div class="container">
	...
	<div class="row justify-content-center">
        <div class="col-md-10">
			...
			<button type="submit" onclick="mercadoPago('{{ $cart_id }}','{{ $url_mercadopago  }}', 'solartekmexico')" class="btn btn-primary btn-block mb-2 mx-2">COMPRAR CON MERCADO PAGO</button>
