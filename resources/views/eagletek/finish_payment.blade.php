...
<div class="container">
	...
	<div class="row justify-content-center">
        <div class="col-md-12">
        	...
        	<h2>¡Listo, selecciona tu metodo de pago!</h2>
        	...
        	<div class="row">
					...
					<table class="table">
					   	...
					   	<tfoot>
					   		...
					   		@if(Session::has('discount_admin'))
						   		<tr>
						   			<td class="text-right" colspan="3"><strong>Descuento -</strong></td>
						   			<td><strong><em>${{ Session::get('discount_admin') }}</em></strong></td>
						   		</tr>
					   		@endif
					   		<tr>
    			...
    			<div class="col-md-6">
    				<dl class="row">
						...
						<dd class="col-md-9">{{ $customer->mail }}</dd>
						...
						<dd class="col-sm-9">{{ $customer->number_out }}</dd>

						<dt class="col-sm-3"> Num. Int.</dt>
						<dd class="col-sm-9">{{ $customer->number_int }}</dd>
			...
			<button type="submit" onclick="mercadoPago('{{ $cart_id }}','{{ $url_mercadopago  }}', 'eagletekmexico')" class="btn btn-primary btn-block mb-2 mx-2">COMPRAR CON MERCADO PAGO</button>
