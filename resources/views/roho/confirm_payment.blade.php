...
<div class="container">
	...
	<div class="row justify-content-center">
        <div class="col-md-12">
        	...
        	@include('parts.form_discount_code',['tienda'=>'roho'])
			<hr>
        	<div class="row">
        			...
        			<div class="col-6">
						...
						@else
							<div class="card">
								<div class="card-body">									
									<a href="{{ route('shoppincart.check.customer',['shop_name'=>'roho'])}}" class="btn btn-warning btn-block">Usar Mis Datos de Envio</a>
								</div>
						    </div>
						    <hr>
        				...
        				<form method="post" action="/shopping-cart/save-datos-comprador">
        					...
        					<input type="hidden" name='tienda' value="roho">
