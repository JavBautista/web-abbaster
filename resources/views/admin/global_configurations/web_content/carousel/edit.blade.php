...
@section('content')
@include('admin.global_configurations.breadcrumb',['item'=>'web_content.caroulsel.edit'])
<div class="container">
  <div class="card">
    <div class="card-body">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
              ...
              <form action="{{ route('global.web.carousel.update') }}" method="post" enctype="multipart/form-data"> 
                      @csrf
