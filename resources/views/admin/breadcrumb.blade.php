<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    @case('store.proveedores.view')
        	<li class="breadcrumb-item"><a href="/dashboard">Index</a></li>
	    	  <li class="breadcrumb-item"><a href="{{ route('store.index', [ 'id'=>$shop->id] ) }}">{{ $shop->name }}</a></li>
  	    	<li class="breadcrumb-item"><a href="{{ route('dashboard.store.proveedores.index', [ 'id'=>$shop->id] ) }}">Proveedores</a></li>
   ...
   @case('store.categories.add')
          <li class="breadcrumb-item"><a href="/dashboard">Index</a></li>
          <li class="breadcrumb-item"><a href="{{ route('store.index', [ 'id'=>$shop->id] ) }}">{{ $shop->name }}</a></li>
          <li class="breadcrumb-item"><a href="{{ route('dashboard.store.categories.index', [ 'id'=>$shop->id] ) }}">Categorias</a></li>
          <li class="breadcrumb-item active" aria-current="page">Add</li>
          @break
  ...
  @case('store.categories.orderby')
    ...
    @case('store.products.add')
          <li class="breadcrumb-item"><a href="/dashboard">Index</a></li>
          <li class="breadcrumb-item"><a href="{{ route('store.index', [ 'id'=>$shop->id] ) }}">{{ $shop->name }}</a></li>
          <li class="breadcrumb-item"><a href="{{ route('dashboard.store.products.index', [ 'id'=>$shop->id] ) }}">Productos</a></li>
          <li class="breadcrumb-item active" aria-current="page">Add</li>
          @break
    ...
    @case('store.sales.view')
          <li class="breadcrumb-item"><a href="/dashboard">Index</a></li>
          <li class="breadcrumb-item"><a href="{{ route('store.index', [ 'id'=>$shop->id] ) }}">{{ $shop->name }}</a></li>
          <li class="breadcrumb-item"><a href="{{ route('dashboard.store.sales.index', [ 'id'=>$shop->id] ) }}">Ventas</a></li>
          <li class="breadcrumb-item active" aria-current="page">View</li>
          @break
