...
@section('content')
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{ route('shops.store', ['shop_slug'=>$shop->slug]) }}">Store</a></li>
			@if($product->category->slug)
				<li class="breadcrumb-item">
					<a href="{{ route('shops.store.category.slug',['shop_slug'=>$shop->slug,'category_slug'=>$product->category->slug]) }} ">
					{{ $product->category->name }}
					</a>
				</li>
			@else
				<li class="breadcrumb-item">
					<a href="{{ route('shops.store.category.id',['shop_slug'=>$shop->slug,'category_id'=>$product->category->id]) }} ">
					{{ $product->category->name }}
					</a>
				</li>
			@endif
	    ...
	    <div class="row justify-content-center">
	        <div class="col-md-10">
				...
				<div class="row">
			        ...
			        <div class="col-md-6">
						@if($product->slug)
						<div class="fb-like" data-href="https://abbaster.com/shop/{{$shop->slug}}/producto/{{$product->slug}}" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
						@endif
	        	...
	        	<div class="row">
						...
						<section>
							@if($product->category->shop->location!='')
					        <div class="text-center my-4">
					            <h3>NUESTRA UBICACI&Oacute;N</h3>
					            <iframe src="{{ $product->category->shop->location }}" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					        </div>
					    @endif
						</section>
