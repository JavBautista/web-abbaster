...
<div class="container">
	...
	<div class="row justify-content-center">
        <div class="col-md-12">
        	...
        	<h2>Ya casi, solo necesitamos tus datos para enviarte tu compra</h2>
        	@include('parts.message_envios')
        	@include('parts.form_discount_code',['tienda'=>'euderm'])
			<hr>
        	<div class="row">
        			...
        			<div class="col-6">
        				...
        				<p><em>Para la proteccion y envio de su compra ingrese la siguiente informacion.</em></p>

        				@guest
							<div class="card">
								<div class="card-body">									
									<a href="{{ route('login') }}" class="btn btn-warning btn-block">Eccede a tu cuenta!</a>
						...
						@else
							<div class="card">
								<div class="card-body">									
									<a href="{{ route('shoppincart.check.customer',['shop_name'=>'euderm'])}}" class="btn btn-warning btn-block">Usar Mis Datos de Envio</a>
								</div>
						    </div>
						    <hr>
        				...
        				<form method="post" action="/shopping-cart/save-datos-comprador">
        					...
        					<input type="hidden" name='tienda' value="euderm">
