...
<div class="container">
	...
	<div class="row justify-content-center">
        <div class="col-md-10">
        	...
        	<div class="row">
        		<div class="col-12">
        		<p><a href="/" class="btn btn-primary float-right mb-4">He terminado, regresar al inicio.</a></p>
        		</div>
        	</div>
        	<div class="row">
    			...
    			<div class="col-6">
    				<dl class="row">
						...
						<dd class="col-sm-8">{{ $purchase->zip_code }}</dd>
						<dt class="col-sm-4">Direccion</dt>
						<dd class="col-sm-8">{{ $purchase->address }}</dd>
						<dt class="col-sm-4">Colonia</dt>
						<dd class="col-sm-8">{{ $purchase->district }}</dd>
						<dt class="col-sm-4">Ciudad</dt>
						<dd class="col-sm-8">{{ $purchase->city }}</dd>
						<dt class="col-sm-4">Estado</dt>
						<dd class="col-sm-8">{{ $purchase->state }}</dd>
